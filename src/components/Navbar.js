...
function Navbar() {
    return (
        ...
        <Link class="navbar-brand" href="/Portfolio/index.html">Ryan Whitcomb</Link>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <Link class="nav-item nav-link" href="/Portfolio/portfolio.html">Portfolio</Link>
                <Link class="nav-item nav-link" href="/Portfolio/contact.html" tabindex="-1"
                    aria-disabled="true">Contact</Link>
                <Link class="nav-item nav-link active" href="/Portfolio/index.html">About<span
